<!-- Why Choose Section -->
<section class="saas-feature-block1 ptb-60 pdt-sm-0 pdb-90 bg-no-repeat bg-cover bg-pos-cc"
    data-overlay-light="7"
    data-background="{{ asset('assets/images/bg/9.jpg') }}"
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6">
                <div class="banner-info">
                    <h2 class="banner-title mrb-10 title-heading">
                        Why Choose
