            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 m-auto">
                        <main id="infographic" class="d-flex flex-column align-items-center">
                            <!-- Step 1: Main Content -->
                            <div class="step one">
                                <div class="row align-items-center">
                                    <!-- Logo/Circle Column -->
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                        <div>
                                            <!-- Article 1: Profile Strategy -->
                                            <article data-step="1">
                                                <div class="d-flex align-items-center bg-opacity-10 header-title">
                                            ...
                                            <!-- Article 2: Evidence Translation -->
                                            <article data-step="2">
                                                <div class="d-flex align-items-center bg-opacity-10 header-title">
                                                    <div class="expect-from">
                                            ...
                                            <!-- Article 3: Letter Development -->
                                            <article data-step="3">
                                                <div class="d-flex align-items-center bg-opacity-10 header-title">
                                                    <div class="expect-from">
                                                        <img src="{{ asset('assets/images/inner-images/o-1visa3.png') }}" alt="Letter Development">
                                                    </div>
                                                    <h6 class="ps-4">
                                            ...
                                            <!-- Article 4: Narrative Structuring -->
                                            <article data-step="4">
                                                <div class="d-flex align-items-center bg-opacity-10 header-title">
                                                    <div class="expect-from">
