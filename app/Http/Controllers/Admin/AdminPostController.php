    ...
    public function store(Request $request)
{
    ...
    if ($request->hasFile('featured_image')) {
        ...
        $featuredImageUrl = asset('storage/' . $featuredImagePath);

        // Auto-populate og_image and twitter_image if they are set to use featured image
        if ($validated['og_image'] === 'USE_FEATURED_IMAGE' || empty($validated['og_image'])) {
            $validated['og_image'] = $featuredImageUrl;
        }

        if ($validated['twitter_image'] === 'USE_FEATURED_IMAGE' || empty($validated['twitter_image'])) {
            $validated['twitter_image'] = $featuredImageUrl;
        }
    } else {
        // Clear og_image and twitter_image if no featured image is uploaded
